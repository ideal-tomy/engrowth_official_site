      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="flex flex-col gap-5 lg:gap-6">
          ...
          <div className="text-[15px] leading-7 text-neutral-800">
            ...
            <p>具体的には、質の高いインプットを大量に行いつつ、それを「使える知識」へと変えるためのアウトプットの自動化トレーニングを重視しています。 海外の名門大学の研究知見も応用 特に、ハーバード大学などのトップレベルの研究機関で効果が実証されている集中的な語学教育の知見をカリキュラム設計に応用。マンツーマンでの演習や、｢英語を英語のまま理解する」ことを意識し、知識を「生きたコミュニケーション能力」に昇華させるプロセスを構築しています。 長年の研究と、世界最高峰の教育メソッドから導き出された「最短で結果を出すための最適解」を、あなたの学習に落とし込みます。無駄なく、着実に、英語を武器にしたい方は、ぜひEngrowthで本物の学習法を体験してください。</p>
          </div>
        </div>
      </div>
    </div>
